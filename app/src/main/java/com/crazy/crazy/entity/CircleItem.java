package com.crazy.crazy.entity;
...
import com.crazy.crazy.util.ImageUtil;
...
/*
    ...
    /**
     * goodjobs replys nickName createTime content userId id
     *
     */
    public CircleItem(String content, String userId, String nickName, List<FavortItem> goodjobs, List<CommentItem> replys) {
    ...
    public String toString() {
        return "CircleItem{" +
                "address='" + address + '\'' +
                ", appointUserNickname='" + appointUserNickname + '\'' +
                ", appointUserid='" + appointUserid + '\'' +
                ", content='" + content + '\'' +
                ", createTime=" + createTime +
                ", goodjobCount=" + goodjobCount +
                ", id='" + id + '\'' +
                ", isvalid='" + isvalid + '\'' +
                ", latitude=" + latitude +
                ", longitude=" + longitude +
